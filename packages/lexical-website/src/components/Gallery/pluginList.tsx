...
export const plugins = (customFields: {
  ...
  },
  {
    ...
    uri: 'https://stackblitz.com/github/abhijeet-tezminds/lexical-update/tree/fix/collab_example/examples/react-rich-collab?ctl=0&file=src%2Fmain.tsx&terminalHeight=0&embed=1',
  },
  {
